...
CVehicle::CVehicle(eVehicleCreatedBy createdBy) : CPhysical(), m_vehicleAudio(), m_autoPilot() {
    ...
    m_StoredCollPolys[0].bValidPolyStored = 0;
    m_StoredCollPolys[1].bValidPolyStored = 0;
...
void CVehicle::UpdateLightingFromStoredPolys() {
  m_storedCollisionLighting[0] = m_StoredCollPolys[0].lighting;
  m_storedCollisionLighting[1] = m_StoredCollPolys[0].lighting;

  m_storedCollisionLighting[2] = m_StoredCollPolys[1].lighting;
  m_storedCollisionLighting[3] = m_StoredCollPolys[1].lighting;
}
