...
enum eStoredColsPoly : int32 { // NOTSA
    COL_FRONT = 0,
    COL_REAR = 1,
    COL_TOTAL
};
...
public:
    ...
    CEntity*          m_pEntityWeAreOn; // we get it from CWorld::ProcessVerticalLine or ProcessEntityCollision, it's entity under us, // ex pEntityWeAreOnForVisibilityCheck
